...
/*   Updated: 2022/04/29 16:01:59 by liglesia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
		...
		// [3] ISALNUM
		int ft_isalnum(int c);
		// Comprueba (1/0) si el int recibido corresponde a una letra o dígito en ASCII
		...
		// [6] STRLEN
		size_t ft_strlen(char *str);
		// Calcula la longitud de un string. Devuelve unsigned int (size_t) len.

		// [7] MEMSET
		void	*ft_memset(void *str, int c, size_t n);
		// Traslada el int c (transformado a unsigned char) a las n posiciones
		// de str, a través del *str.
